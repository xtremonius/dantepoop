...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ asset('js/calendar/index/calendar.js') }}" defer></script>
            <!-- cdn js bootstrap -->
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtTime" name="txtTime" placeholder="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      {{-- <select class="form-control" id="txtColor" name="txtColor">
                                        <option>Rojo</option>
                                        <option>Verde</option>
                                        <option>Azul</option>
...
{{--                                 <input type="text" name="txtID" id="txtID">
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="btnCancelar" class="btn btn-info" data-dismiss="modal">Cancelar</button>
